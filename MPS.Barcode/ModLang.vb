Module ModLang
    ...
    End Function
    Public Function TextMultiLang(ByVal MsgVN As String, ByVal ID As Integer) As String
        Dim s As String = MsgVN

        Dim iLang As Integer = 1
        ...
        End If
        If iLang <> 1 Then
            Dim ds As DataSet = OpenDataSetAccess("Select Msg from tblMultiMsg where LangID=" & iLang.ToString & " AND IDMsg=" & ID.ToString & "")
            If Not ds Is Nothing AndAlso ds.Tables(0).Rows.Count > 0 Then
                s = ds.Tables(0).Rows(0)("Msg").ToString
            End If
        End If
