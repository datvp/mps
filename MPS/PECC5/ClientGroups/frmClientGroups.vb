...
#Region "Form "
    ...
    Private Sub frmClientGroups_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Sub "
    ...
    Private Sub Security()
        Dim m As Model.MFuncRight = ModMain.getPermitFunc(ModMain.m_UIDLogin, 5)
