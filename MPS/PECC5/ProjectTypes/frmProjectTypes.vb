...
Public Class frmProjectTypes
    Private WithEvents cls As BLL.BProjectTypes = BLL.BProjectTypes.Instance
...
#Region "Form "
    ...
    Private Sub frmProjectTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Loadlist()

    End Sub

    Private Sub frmProjectTypes_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub frmProjectTypes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Sub "
    ...
    Private Sub Security()
        Dim m As Model.MFuncRight = ModMain.getPermitFunc(ModMain.m_UIDLogin, 10)
        ...
        If Not Grid.DataSource Is Nothing Then
            If Not Grid.ActiveRow Is Nothing Then
                If Grid.ActiveRow.Index <> -1 And Not Grid.ActiveRow.Cells Is Nothing Then
                    ProjectTypeId = Grid.ActiveRow.Cells("ProjectTypeId").Value
                End If
            End If
        End If

        Grid.DataSource = cls.getListProjectTypes()
            ...
            If Grid.Rows.Count > 0 Then
                For i As Integer = 0 To Grid.Rows.Count - 1
                    ...
                    If r.ChildBands Is Nothing Then
                        If r.Cells("ProjectTypeId").Value = ProjectTypeId Then
                            r.Activated = True
                            Exit Sub
                        End If

                    Else
                        FindItem(r, "ProjectTypeId", ProjectTypeId)
    ...
    Private Sub Edit()
        ...
        Dim frm As New frmProjectTypeDetail
        Dim result = frm.ShowDialog(r.Cells("ProjectTypeId").Value)
        If result <> "" Then
            Me.Loadlist()
            For i As Integer = 0 To Grid.Rows.Count - 1
                If Grid.Rows(i).Cells("ProjectTypeId").Value.ToString = result Then
        ...
        Try
            If Grid.Selected.Rows.Count > 1 Then
                ...
                For i As Integer = 0 To Grid.Selected.Rows.Count - 1
                    id = Grid.Selected.Rows(i).Cells("ProjectTypeId").Value
                    name = Grid.Selected.Rows(i).Cells("ProjectTypeName").Value
                ...
                Next
            Else 'xóa 1 dòng
                id = r.Cells("ProjectTypeId").Value
                name = r.Cells("ProjectTypeName").Value
...
#Region "Grid "
    ...
    Private Sub Grid_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Grid.DoubleClick
        ...
        If fselect Then
            Sselect = r.Cells("ProjectTypeId").Value
            Me.Close()
            Exit Sub
        End If
