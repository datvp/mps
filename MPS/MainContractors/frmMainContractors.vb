...
Public Class frmMainContractors
    Private WithEvents cls As BLL.BMainContractors = BLL.BMainContractors.Instance
...
#Region "Form "
    ...
    Private Sub frmMainContractors_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Loadlist()
    End Sub


    Private Sub frmMainContractors_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub frmMainContractors_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Sub "
    ...
    Private Sub Security()
        Dim m As Model.MFuncRight = ModMain.getPermitFunc(ModMain.m_UIDLogin, 9)
        ...
        If Not Grid.DataSource Is Nothing Then
            If Not Grid.ActiveRow Is Nothing Then
                If Grid.ActiveRow.Index <> -1 And Not Grid.ActiveRow.Cells Is Nothing Then
                    s_ID = Grid.ActiveRow.Cells("Id").Value
                End If
            End If
        End If

        Grid.DataSource = cls.getListMainContractors()
    ...
    Private Sub Edit()
        ...
        Dim frm As New frmMainContractorDetail
        Dim result = frm.ShowDialog(r.Cells("Id").Value)
        If result <> "" Then
            Me.Loadlist()
            For i As Integer = 0 To Grid.Rows.Count - 1
                If Grid.Rows(i).Cells("Id").Value.ToString = result Then
        ...
        Try
            If Grid.Selected.Rows.Count > 1 Then
                ...
                For i As Integer = 0 To Grid.Selected.Rows.Count - 1
                    id = Grid.Selected.Rows(i).Cells("Id").Value
                    name = Grid.Selected.Rows(i).Cells("Company").Value
